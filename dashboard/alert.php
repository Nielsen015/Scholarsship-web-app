                ...
                $query_run = mysqli_query($connection,$query);
                 ...
                 ?>
                  ...
                  <?php } ?></td>
                            ...
                            <td><a href="Open_message? id=<?php echo $row['id'];?>"><button>Read</button>
                            <form action="initialize.php" method="post">
                            <input type="hidden" name="delete_text" value="<?php echo $row['id']; ?>">
                            <button type="submit" name="delete_textbtn"><i class="fa-solid fa-trash"></i></button></a>
                            </form>
                            </td>
                            <div class="echo_text">
                            <?php
